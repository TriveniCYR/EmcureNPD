    ...
    var columnObject = [
        ...
        },
        {
            "data": "Action", "name": "Action", "render": function (data, type, row, meta) {
                ...
                html += '<a title="Edit" class="btn btn-primary"  href="/User/UserManage?UserId='+row.userId+'"><i class="fa fa-fw fa-edit mr-1"></i></a>';
                html += '<a title="Delete" class="btn btn-danger ml-2" data-toggle="modal" data-target="#DeleteUserModel" data-backdrop="static" data-keyboard="false" onclick="ConfirmationDeleteUser(' + row.userId + '); return false;"><i class="fa fa-fw fa-trash mr-1"></i></a>';
