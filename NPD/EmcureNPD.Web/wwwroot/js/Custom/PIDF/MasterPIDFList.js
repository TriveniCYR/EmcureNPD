        ...
        },
        {
            "data": null, "name": "Action", "render": function (data, type, row, meta) {
                ...
                if (_screenId == "1") {
                    ...
                    var _enable = (row.pidfStatusID == 7 || row.pidfStatusID == 9 || row.pidfStatusID == 10 || row.pidfStatusID == 11);
                    ...
                    html += '<a class="large-font" title="RnD" style="color:' + (_enable ? "#007bff" : "grey") + '" href="' + (_enable ? _NewPBFForm + "PBFRnDDetailsForm" + _APIQS : "#") + '"><i class="fa fa-fw fa-columns mr-1"></i></a>';
                    html += '<a class="large-font" title="Analytical" style="color:' + (_enable ? "#007bff" : "grey") + '" href="' + (_enable ? _NewPBFForm + "PBFAnalyticalDetailsForm" + _APIQS : "#") + '"><i class="fa fa-fw fa-flask mr-1"></i></a>';
                    html += '<a class="large-font" title="Clinical" style="color:' + (_enable ? "#007bff" : "grey") + '" href="' + (_enable ? _NewPBFForm + "PBFClinicalDetailsForm" + _APIQS : "#") + '"><i class="fa fa-fw fa-map-marker mr-1"></i></a>';
