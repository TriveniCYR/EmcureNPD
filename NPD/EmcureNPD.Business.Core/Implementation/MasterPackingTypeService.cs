...
namespace EmcureNPD.Business.Core.Implementation
{
    public class MasterPackingTypeService : IMasterPackingTypeService
    {
        ...
        public async Task<DBOperation> AddUpdatePackingType(MasterPackingTypeEntity entityPackingType)
        {
            ...
            {
                var objModelData = _repository.Exists(x => x.PackingTypeName.ToLower() == entityPackingType.PackingTypeName.ToLower() && x.PackingTypeId!= entityPackingType.PackingTypeId);
                if (objModelData)
