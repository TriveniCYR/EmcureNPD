    ...
    public class RegionController : ControllerBase
    {
        ...
        public async Task<IActionResult> InsertUpdateRegion(MasterRegionEntity oRegion)
        {
            try
            {
                ...
                { return _ObjectResponse.Create(false, (Int32)HttpStatusCode.BadRequest, (oResponse == DBOperation.AlreadyExist ? "Region Name '<b>" + oRegion.RegionName + "</b>' Already Exist" : "Bad request")); } 
                else
