    ...
    public class PackagingTypeController : ControllerBase
    {
        ...
        public async Task<IActionResult> InsertUpdatePackagingType(MasterPackagingTypeEntity oPackagingType)
        {
            try
            {
                ...
                { return _ObjectResponse.Create(false, (Int32)HttpStatusCode.BadRequest, (oResponse == DBOperation.AlreadyExist ? "Packaging Type Name'<b>" + oPackagingType.PackagingTypeName + "</b>' Already Exist" : "Bad request")); }
                else
