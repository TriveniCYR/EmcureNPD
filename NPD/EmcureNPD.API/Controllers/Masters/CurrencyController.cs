    ...
    public class CurrencyController : ControllerBase
    {
        ...
        public async Task<IActionResult> InsertUpdateCurrency(MasterCurrencyEntity oCurrency)
        {
            try
            {
                ...
                { return _ObjectResponse.Create(false, (Int32)HttpStatusCode.BadRequest, (oResponse == DBOperation.AlreadyExist ? "Currency Name'<b>" + oCurrency.CurrencyName + "</b>' Already Exist" : "Bad request")); }
                else
