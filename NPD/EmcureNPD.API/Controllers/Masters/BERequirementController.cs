    ...
    public class BERequirementController : ControllerBase
    {
        ...
        public async Task<IActionResult> InsertUpdateBERequirement(MasterBERequirementEntity oBERequirement)
        {
            try
            {
                ...
                { return _ObjectResponse.Create(false, (Int32)HttpStatusCode.BadRequest, (oResponse == DBOperation.AlreadyExist ? "BE Requirement Name'<b>" + oBERequirement.BERequirementName + "</b>' Already Exist" : "Bad request")); }
                else
