    ...
    public class CountryController : ControllerBase
    {
        ...
        public async Task<IActionResult> InsertUpdateCountry(MasterCountryEntity oCountry)
        {
            try
            {
                ...
                { return _ObjectResponse.Create(false, (Int32)HttpStatusCode.BadRequest, (oResponse == DBOperation.AlreadyExist ? "Country Name'<b>" + oCountry.CountryName + "</b>' Already Exist" : "Bad request")); }
                else
