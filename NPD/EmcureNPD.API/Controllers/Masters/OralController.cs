    ...
    public class OralController : ControllerBase
    {
        ...
        public async Task<IActionResult> InsertUpdateOral(MasterOralEntity oOral)
        {
            try
            {
                ...
                { return _ObjectResponse.Create(false, (Int32)HttpStatusCode.BadRequest, (oResponse == DBOperation.AlreadyExist ? "Oral Name'<b>" + oOral.OralName + "</b>' Already Exist" : "Bad request")); }
                else
