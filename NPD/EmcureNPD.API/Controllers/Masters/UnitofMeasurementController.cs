    ...
    public class UnitofMeasurementController : ControllerBase
    {
        ...
        public async Task<IActionResult> InsertUpdateUnitofMeasurement(MasterUnitofMeasurementEntity oUnitofMeasurement)
        {
            try
            {
                ...
                { return _ObjectResponse.Create(false, (Int32)HttpStatusCode.BadRequest, (oResponse == DBOperation.AlreadyExist ? "Unit of Measurement Name'<b>" + oUnitofMeasurement.UnitofMeasurementName + "</b>' Already Exist" : "Bad request")); }
                else
