    ...
    public class FilingTypeController : ControllerBase
    {
        ...
        public async Task<IActionResult> InsertUpdateFilingType(MasterFilingTypeEntity oFilingType)
        {
            try
            {
                ...
                { return _ObjectResponse.Create(false, (Int32)HttpStatusCode.BadRequest, (oResponse == DBOperation.AlreadyExist ? "Filing Type Name'<b>" + oFilingType.FilingTypeName + "</b>' Already Exist" : "Bad request")); }
                else
