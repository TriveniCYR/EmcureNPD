    ...
    public class DepartmentController : ControllerBase
    {
        ...
        public async Task<IActionResult> InsertUpdateDepartment(MasterDepartmentEntity oDepartment)
        {
            try
            {
                ...
                { return _ObjectResponse.Create(false, (Int32)HttpStatusCode.BadRequest, (oResponse == DBOperation.AlreadyExist ? "Department Name'<b>" + oDepartment.DepartmentName + "</b>' Already Exist" : "Bad request")); }
                else
