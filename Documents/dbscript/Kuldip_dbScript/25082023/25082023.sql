...
GO
/****** Object:  StoredProcedure [dbo].[stp_npd_GetPIDFList]    Script Date: 25-08-2023 11:15:50 ******/
DROP PROCEDURE IF EXISTS [dbo].[stp_npd_GetPIDFList]
GO
/****** Object:  StoredProcedure [dbo].[stp_npd_GetCanBeApprove]    Script Date: 25-08-2023 11:15:50 ******/
DROP PROCEDURE IF EXISTS [dbo].[stp_npd_GetCanBeApprove]
GO
/****** Object:  StoredProcedure [dbo].[std_npd_GetIsInterestedByPIDFandBU]    Script Date: 25-08-2023 11:15:50 ******/
DROP PROCEDURE IF EXISTS [dbo].[std_npd_GetIsInterestedByPIDFandBU]
GO
/****** Object:  StoredProcedure [dbo].[std_npd_GetIsAlloeToApprove]    Script Date: 25-08-2023 11:15:50 ******/
DROP PROCEDURE IF EXISTS [dbo].[std_npd_GetIsAlloeToApprove]
GO
/****** Object:  UserDefinedFunction [dbo].[GetCanBeApprove]    Script Date: 25-08-2023 11:15:50 ******/
...
GO
 -- select dbo.GetCanBeApprove(175)
...
AS                          
BEGIN
select  dbo.GetCanBeApprove(@PIDFID)
end
GO
/****** Object:  StoredProcedure [dbo].[std_npd_GetIsInterestedByPIDFandBU]    Script Date: 25-08-2023 11:15:50 ******/
SET ANSI_NULLS ON
...
dbo.GetCanBeApprove(PIDFID) as IsAllowApprove,
