...
$(function () {
    $(document).on("click", ".expand1", function () {
        $('.min-max').removeClass('direct-chat-messages');
        $(this).removeClass('expand1').addClass('compress1');

    });

    $(document).on("click", ".compress1", function () {
        $('.min-max').addClass('direct-chat-messages');
        $(this).removeClass('compress1').addClass('expand1');
    });
