...
FileTypes.document = new Array("doc", "docx", "txt", "rtf", "pdf", "xls", "xlsx", "mdb", "html", "htm", "db");
...
RoxyUtils.GetFileIcon = function (a) {
    ...
    if (fileTypeIcons[RoxyUtils.GetFileExt(a).toLowerCase()]) {
        ret = "images/filetypes/big/" + fileTypeIcons[RoxyUtils.GetFileExt(a).toLowerCase()]
    }
    return ret
};
...
function File(d, a, c, b, e) {
    ...
    this.Show = function () {
        if (this.type == '') {
            ...
            html = '<li data-path="' + this.fullPath + '" data-dirs="' + this.dirs + '" data-icon="images/folder.png" data-files="' + this.files + '" class="directory" data-icon-big="' + (this.IsImage() ? "images/folder.png" : "images/folder.png") + '">';
            //html += '<img src="images/' + (this.dirs > 0 ? "dir-plus.png" : "blank.gif") + '" class="dirPlus" width="9" height="9">';
            html += '<img src="images/folder.png" class="icon"><span class="name">' + this.name + "</span>";
            html += "</li>";
...
function Directory(a, c, b) {
    ...
    this.GetHtml = function () {
        ...
        d += '<img src="images/folder.png" class="dir"><span class="name">' + this.name +"</span></div>";
        d += "</li>";
        return d
    };
